...
const config = {
  ...
  jwtSecret: process.env.JWT_SECRET || 'nuvyra-insecure-secret-change-me',
  jwtExpires: process.env.JWT_EXPIRES || '7d',
  mongoUri: process.env.MONGO_URI || 'mongodb://admin:password123@127.0.0.1:27017/nuvyra?authSource=admin',
  dbPath: path.resolve(root, process.env.DB_PATH || 'data/nuvyra.db'),
  ...
  mail: {
    ...
    from: process.env.MAIL_FROM || 'nuvyra <no-reply@nuvyra.local>',
  },
